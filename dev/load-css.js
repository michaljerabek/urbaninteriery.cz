...
(function (file, comp, lib, _insert, _isBuild) {
    ...
    var FILES = {
            "all.build.css": [
                ...
                lib("blueimp-Gallery/css/blueimp-gallery.css"),
                lib("blueimp-Gallery/css/blueimp-gallery--rewrite.css"),

                comp("ui.css"),
                comp("btn.css"),
                comp("page-header.css"),
                comp("main-nav.css"),
                comp("page-footer.css"),
                comp("contact.css"),

                comp("section/section.css"),
                comp("section/offer-section.css"),
                comp("section/progress-section.css"),
                comp("section/references-section.css")
            ],
